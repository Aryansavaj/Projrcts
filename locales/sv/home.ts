...
export const homeData: HomeData = {
  ...
  heroBlackTitle: "Lär dig utan",
  heroBlueTitle: "gränser",
  heroSubtitle:
    "Lär dig allt du behöver veta för att starta, växa och förvalta ett framgångsrikt dropshipping företag.",
  ...
  platformSubtitle:
    "Checkified använder automatiserade processer för att underlätta sömlöst lärande. Vårt mål är att göra det möjligt för enskilda personer att enkelt etablera sina egna företag.",
  featureData: [
    {
      id: 1,
  ...
  expertiseData: [
    {
      ...
      titleBlue: "Grunden",
      subtitle:
        "Checkified skapar en idealisk miljö för din e-handelsresa. Den här formeln kommer att fungera som grund för din online-verksamhet.",
      lists: [
        {
          id: 1,
          name: "Introduktion"
