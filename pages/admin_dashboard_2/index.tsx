...
export default function Profile_setting_pop({}: Props) {
  ...
  const adminItems = [
    { title: 'Item 1', count: 5, date: '2023-06-01', imageUrl: '/images/dashboard/image-1.png' },
    { title: 'Item 2', count: 10, date: '2023-06-02', imageUrl: '/images/dashboard/image-1.png' },
    { title: 'Item 3', count: 7, date: '2023-06-03', imageUrl: '/images/dashboard/image-1.png' },
  ];
  return (
