                    ...
                    <div className="relative">
                      <div className="bg-base-100 w-full flex items-center rounded-corner">
                        ...
                        <input
                          ...
                          className="input admin-outline-none bg-base-100 w-[17.9rem]"
                        />
                        <button className="btn hover-none bg-primary btn-shadow rounded-full text-white border-2 border-white px-6">
                          <Image
