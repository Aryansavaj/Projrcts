                  ...
                  <Link key="" href="">
                    <div className="mega-menu-list items-center flex gap-3 items-start  rounded-lg">
                      ...
                      <div>
                        <button
                          type="button"
                          className="btn mr-2 h-10 w-full btn-primary  hover:bg-gray-100 hover:border-gray-200 items-center isolate"
                        >
                ...
                <div key="" className="py-2 px-2">
                  <div className=" flex relative">
                    <input
                      ...
                      className="px-4 py-3 rounded-lg mr-2 text-subtitle-dark focus:outline-primary bg-transparent placeholder-gray-200"
                    />
