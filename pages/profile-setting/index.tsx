      ...
      <section className="mb-8 lg:mb-8">
        ...
        <Link  href="/profile-setting">
          <div className="flex items-center gap-2 text-1xl font-semibold">
            <div className="bg-primary text-white rounded-full btn-shadow text-3xl px-2 py-2 font-bold w-[50px] text-center page_title-font-size">
              1
            </div>
            Information
          </div>
        ...
        <div className="p-8 lg:p-8 bg-primary rounded-[28px] gap-8 profile_grid_inner_set_2 h-5/6">
          ...
          <section className="relative mb-28">
            <div className="grid grid-cols-1 gap-6 mb-20">
              ...
              <p class="text-[11px] text-white self-center font-semibold">Krypterade och Säkra Betalningar</p>
              </div>
            </div>
          </section>
        </div>
