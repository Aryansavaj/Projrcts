        ...
        <div className="admin_list_content flex gap-4 items-center">
          ...
          <div className="admin_list_detail">
            ...
            <div className="admin_list_extra flex gap-4 items-center">
              <div className="admin_list_count font-medium text-[10px] text-707BA0 flex items-center">
              <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {count}</div>
              <div className="admin_list_date font-medium text-[10px] text-707BA0 flex items-center">
              <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
